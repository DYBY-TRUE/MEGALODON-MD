...
*⚡️POWERED BY MEGALODON MD ⚡*
`;

        // Remplacer ce lien par l'URL de l'image que tu m'enverras
        const imageUrl = "https://files.catbox.moe/xko1l6.jpg"; // Remplace "TON_LIEN_IMAGE_ICI" par ton lien d'image
        ...
        await conn.sendMessage(m.chat, {
            image: { url: imageUrl },
            caption: `📖 *BIBLE LIST BY MEGALODON MD*:\n\n` +
